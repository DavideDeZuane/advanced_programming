...
export {client, component_controller, employee_controller, prototype_controller, device, system_controller, file_controller, version_controller, operation_controller}
